...
from SKILLS.tiktok_ads_researcher.schemas import (
    TikTokAdsResearchInput,
    TikTokAdsResearchOutput,
)
from SKILLS.tiktok_ads_researcher.service import TikTokAdsResearcherSkill
...
async def test_run_happy_path(skill: TikTokAdsResearcherSkill, input_data: TikTokAdsResearchInput) -> None:
    ...
    with (
        patch(
            "SKILLS.tiktok_ads_researcher.service.api_client.fetch_ads",
            new_callable=AsyncMock,
            return_value=_fake_api_response("US"),
        ) as mock_fetch,
        patch(
            "SKILLS.tiktok_ads_researcher.service.cache.get_cached",
            new_callable=AsyncMock,
            return_value=None,
        ),
        patch(
            "SKILLS.tiktok_ads_researcher.service.cache.set_cached",
            new_callable=AsyncMock,
        ) as mock_set_cache,
        patch(
            "SKILLS.tiktok_ads_researcher.service.get_supabase",
