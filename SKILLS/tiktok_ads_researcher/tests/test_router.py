...
from SKILLS.tiktok_ads_researcher.router import router
from SKILLS.tiktok_ads_researcher.schemas import TikTokAdsResearchOutput
...
def test_run_success() -> None:
    ...
    with patch(
        "SKILLS.tiktok_ads_researcher.router._skill.run",
