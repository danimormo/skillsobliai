...
from SKILLS.supplier_researcher.router import router
from SKILLS.supplier_researcher.schemas import SupplierResearchOutput, SupplierProduct
...
@pytest.mark.asyncio
@patch("SKILLS.supplier_researcher.router._skill")
