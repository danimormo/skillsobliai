...
from SKILLS.content_researcher.router import router
from SKILLS.content_researcher.schemas import ContentResearchOutput
...
def test_run_endpoint_success():
    ...
    with patch(
        "SKILLS.content_researcher.router._skill.run",
