...
from SKILLS.content_researcher.schemas import ContentResearchInput, ContentResearchOutput
from SKILLS.content_researcher.service import ContentResearcherSkill
...
@router.post("/run", response_model=SkillResult[ContentResearchOutput])
async def run_content_research(
    body: ContentResearchInput,
    authorization: str = Header(...),
) -> SkillResult[ContentResearchOutput]:
    """Run a content research query across TikTok and Pinterest."""
