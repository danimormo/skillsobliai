...
@pytest.mark.asyncio
@patch("SKILLS.07_supplier_researcher.service.get_supabase")
@patch("SKILLS.07_supplier_researcher.service.cache")
@patch("SKILLS.07_supplier_researcher.service.api_client")
