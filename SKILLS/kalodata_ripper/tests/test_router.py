...
from SKILLS.kalodata_ripper.router import router
from SKILLS.kalodata_ripper.schemas import KalodataRipperOutput
...
def test_run_success():
    ...
    with patch.object(
        ...
        with patch(
            "SKILLS.kalodata_ripper.router._skill.run",
