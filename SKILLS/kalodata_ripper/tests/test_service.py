...
from SKILLS.kalodata_ripper.schemas import KalodataRipperInput
...
async def test_happy_path_downloads_and_uploads():
    ...
    with (
        patch("SKILLS.kalodata_ripper.service.api_client.fetch_product_videos", new_callable=AsyncMock) as mock_fetch,
        patch("SKILLS.kalodata_ripper.service.get_supabase", return_value=mock_sb),
        patch("SKILLS.kalodata_ripper.service.httpx.AsyncClient", return_value=mock_http_client),
    ):
