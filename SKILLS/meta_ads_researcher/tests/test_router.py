...
from SKILLS.meta_ads_researcher.router import router
from SKILLS.meta_ads_researcher.schemas import MetaAdsResearchOutput
...
def test_run_success():
    ...
    with patch(
        "SKILLS.meta_ads_researcher.router._skill.run",
