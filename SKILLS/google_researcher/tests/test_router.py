...
from SKILLS.google_researcher.router import router
from SKILLS.google_researcher.schemas import GoogleResearchOutput
...
async def test_run_endpoint_success():
    ...
    with patch(
        "SKILLS.google_researcher.router._skill.run",
