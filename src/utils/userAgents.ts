/**
 * Rotating pool of realistic desktop User-Agent strings (Chrome/Edge/Firefox/Safari,
 * Windows + macOS). Updated to cover late-2025 / 2026 versions so headless fingerprints
 * don't lag behind actual browsers. Mobile UAs are intentionally excluded to keep the
 * layout consistent with desktop CSS selectors used by suppliers.
 */
